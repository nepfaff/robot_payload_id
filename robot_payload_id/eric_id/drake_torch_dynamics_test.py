...
def add_model_panda(plant):
    model_file = "/models/add_panda.dmd.yaml"
    directives = LoadModelDirectives(model_file)
...
class Test(unittest.TestCase):
    ...
    def test_inertial_parameterizations(self):
        ...
        inertial_params_1 = LogCholeskyInertialParameter(masses, coms, rot_inertias)
        check_inertial_param(inertial_params_1)
        inertial_params_2 = MassAndComInertialParameter.from_other(inertial_params_1)
    ...
    def check_model(self, add_model):
        ...
        self.check_forward_and_backward(add_model, LogCholeskyInertialParameter)
        # Batched.
    ...
    def test_inertial_entropic_divergence(self):
        ...
        entropic_divergence = InertialEntropicDivergence(masses, coms, rot_inertias)
